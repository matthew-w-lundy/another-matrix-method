...
norm_smooth_size = [3.0 * smooth_size for i in range(0, logE_nbins)]
for logE in range(0, logE_nbins):
    scale_size = max(3.0, float(logE))
...
print(
    f"xsky_start = {xsky_start}, xsky_end = {xsky_end}, ysky_start = {ysky_start}, ysky_end = {ysky_end}"
)

if onoff == "ON":
    skymap_bins = fine_skymap_bins
    print(f"original skymap_bins = {skymap_bins}")
    skymap_bin_size = 2.0 * fine_skymap_size / float(skymap_bins)

region_name = source_name
if onoff == "OFF":
    region_name = "Validation"
all_roi_name, all_roi_x, all_roi_y, all_roi_r = DefineRegionOfInterest(
    region_name, src_ra, src_dec, coordinate_type=coordinate_type
)
all_excl_name, all_excl_x, all_excl_y, all_excl_r = DefineRegionOfExclusion(
    region_name, src_ra, src_dec, coordinate_type=coordinate_type
)
...
sum_data_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_bkgd_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_syst_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_significance_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_significance_sky_map_LE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_significance_sky_map_HE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_excess_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_excess_sky_map_LE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_excess_sky_map_HE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_allE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_sky_map_allE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_allE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_allE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_LE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_LE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_HE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_HE = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_sky_map_LE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_LE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_LE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_sky_map_HE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_err_sky_map_HE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
sum_flux_syst_sky_map_HE_smooth = MyArray3D(
    x_bins=skymap_bins,
    start_x=xsky_start,
    end_x=xsky_end,
    y_bins=skymap_bins,
...
for mimic in range(1, n_mimic + 1):
    mimic_data_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_data_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_data_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_bkgd_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_bkgd_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_bkgd_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_significance_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_significance_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_significance_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_excess_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_excess_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_excess_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_allE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_allE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_allE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_LE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_HE = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_LE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_LE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_sky_map_HE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    mimic_flux_err_sky_map_HE_smooth = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
...
for epoch in input_epoch:
    ...
    for mode in onoff_list:
        ...
        input_filename = (
            f"{smi_output}/skymaps_{source_name}_{epoch}_{mode}_{ana_tag}.pkl"
        )
        ...
        for run in range(0, len(analysis_result)):
            ...
            for logE in range(0, logE_nbins):
                ...
                sum_syst += syst
                print(
                    f"logE = {logE}, data = {data}, bkgd = {bkgd:0.1f}, diff = {data-bkgd:0.1f}, syst = {syst:0.1f}"
                )
            ...
            for logE in range(0, logE_nbins):
                ...
                if "MIMIC" in mode:
                    ...
                    if include_syst_error:
                        ...
                        sum_syst_sky_map[logE].add(syst_sky_map[logE], factor=2.0)
...
for logE in range(0, logE_nbins):
    ...
    if model_integral == 0.0:
        continue
    for idx_x in range(0, xoff_bins[logE]):
        for idx_y in range(0, yoff_bins[logE]):
            data = sum_data_xyoff_map[logE].waxis[idx_x, idx_y, 0]
            model = (
                sum_data_xyoff_map[logE].waxis[idx_x, idx_y, 1]
                * data_integral
                / model_integral
            )
            data_err = max(1.0, pow(data, 0.5))
            sum_init_err_xyoff_map[logE].waxis[idx_x, idx_y, 0] = (
                data - model
            ) / data_err
    ...
    for idx_x in range(0, xoff_bins[logE]):
        for idx_y in range(0, yoff_bins[logE]):
            for gcut in range(0, gcut_bins):
                ...
                significance = significance_li_and_ma(data, model, 0.0)
                sum_err_xyoff_map[logE].waxis[idx_x, idx_y, gcut] = significance


for logE in range(0, logE_nbins):
    sum_data_xyvar_map[logE].scale(1.0 / good_exposure)
    sum_data_xyoff_map[logE].scale(1.0 / good_exposure)
    sum_fit_xyoff_map[logE].scale(1.0 / good_exposure)
...
for logE in range(0, logE_nbins):
    ...
    smooth_image(
        sum_incl_sky_map_smooth[logE].waxis[:, :, 0],
        sum_incl_sky_map_smooth[logE].xaxis,
        sum_incl_sky_map_smooth[logE].yaxis,
        kernel_radius=norm_smooth_size[logE],
    )
    smooth_image(
        sum_bkgd_sky_map_smooth[logE].waxis[:, :, 0],
        sum_bkgd_sky_map_smooth[logE].xaxis,
        sum_bkgd_sky_map_smooth[logE].yaxis,
        kernel_radius=smooth_size,
    )
    smooth_image(
        sum_syst_sky_map_smooth[logE].waxis[:, :, 0],
        sum_syst_sky_map_smooth[logE].xaxis,
        sum_syst_sky_map_smooth[logE].yaxis,
        kernel_radius=smooth_size,
    )
    smooth_image(
        sum_data_sky_map_smooth[logE].waxis[:, :, 0],
        sum_data_sky_map_smooth[logE].xaxis,
        sum_data_sky_map_smooth[logE].yaxis,
        kernel_radius=smooth_size,
    )
...
for logE in range(0, logE_nbins):
    for mimic in range(0, n_mimic):
        ...
        sum_mimic_incl_sky_map_smooth[mimic][logE].add(
            sum_mimic_incl_sky_map[mimic][logE]
        )
        sum_mimic_data_sky_map_smooth[mimic][logE].add(
            sum_mimic_data_sky_map[mimic][logE]
        )
        sum_mimic_bkgd_sky_map_smooth[mimic][logE].add(
            sum_mimic_bkgd_sky_map[mimic][logE]
        )
        smooth_image(
            sum_mimic_incl_sky_map_smooth[mimic][logE].waxis[:, :, 0],
            sum_incl_sky_map_smooth[logE].xaxis,
            sum_incl_sky_map_smooth[logE].yaxis,
            kernel_radius=smooth_size,
        )
        smooth_image(
            sum_mimic_bkgd_sky_map_smooth[mimic][logE].waxis[:, :, 0],
            sum_bkgd_sky_map_smooth[logE].xaxis,
            sum_bkgd_sky_map_smooth[logE].yaxis,
            kernel_radius=smooth_size,
        )
        smooth_image(
            sum_mimic_data_sky_map_smooth[mimic][logE].waxis[:, :, 0],
            sum_data_sky_map_smooth[logE].xaxis,
            sum_data_sky_map_smooth[logE].yaxis,
            kernel_radius=smooth_size,
        )
        sum_mimic_data_sky_map_allE[mimic].add(
            sum_mimic_data_sky_map_smooth[mimic][logE]
        )
        sum_mimic_bkgd_sky_map_allE[mimic].add(
            sum_mimic_bkgd_sky_map_smooth[mimic][logE]
        )
        if logE >= logE_min and logE < logE_mid:
            sum_mimic_data_sky_map_LE[mimic].add(
                sum_mimic_data_sky_map_smooth[mimic][logE]
            )
            sum_mimic_bkgd_sky_map_LE[mimic].add(
                sum_mimic_bkgd_sky_map_smooth[mimic][logE]
            )
        if logE >= logE_mid and logE <= logE_max:
            sum_mimic_data_sky_map_HE[mimic].add(
                sum_mimic_data_sky_map_smooth[mimic][logE]
            )
            sum_mimic_bkgd_sky_map_HE[mimic].add(
                sum_mimic_bkgd_sky_map_smooth[mimic][logE]
            )
...
for logE in range(0, logE_nbins):
    ...
    stat_error = 0.0
    if data_sum > 0.0:
        error = 100.0 * (data_sum - bkgd_sum) / data_sum
        stat_error = 100.0 * pow(data_sum, 0.5) / data_sum
    print(
        f"E = {pow(10.,logE_bins[logE]):0.3f} TeV, data_sum = {data_sum}, bkgd_sum = {bkgd_sum:0.1f}, error = {error:0.1f} +/- {stat_error:0.1f} %"
    )

for logE in range(0, logE_nbins):
    make_significance_map(
        sum_data_sky_map_smooth[logE],
        sum_bkgd_sky_map_smooth[logE],
        sum_significance_sky_map[logE],
        sum_excess_sky_map_smooth[logE],
        syst_sky_map=sum_syst_sky_map_smooth[logE],
    )
make_significance_map(
    sum_data_sky_map_allE,
    sum_bkgd_sky_map_allE,
    sum_significance_sky_map_allE,
    sum_excess_sky_map_allE,
    syst_sky_map=sum_syst_sky_map_allE,
)
make_significance_map(
    sum_data_sky_map_LE,
    sum_bkgd_sky_map_LE,
    sum_significance_sky_map_LE,
    sum_excess_sky_map_LE,
    syst_sky_map=sum_syst_sky_map_LE,
)
make_significance_map(
    sum_data_sky_map_HE,
    sum_bkgd_sky_map_HE,
    sum_significance_sky_map_HE,
    sum_excess_sky_map_HE,
    syst_sky_map=sum_syst_sky_map_HE,
)

for mimic in range(0, n_mimic):
    make_significance_map(
        sum_mimic_data_sky_map_allE[mimic],
        sum_mimic_bkgd_sky_map_allE[mimic],
        sum_mimic_significance_sky_map_allE[mimic],
        sum_mimic_excess_sky_map_allE[mimic],
    )

for logE in range(0, logE_nbins):
    avg_energy = 0.5 * (
        pow(10.0, logE_axis.xaxis[logE]) + pow(10.0, logE_axis.xaxis[logE + 1])
    )
    delta_energy = 0.5 * (
        pow(10.0, logE_axis.xaxis[logE + 1]) - pow(10.0, logE_axis.xaxis[logE])
    )
    make_flux_map(
        sum_incl_sky_map_smooth[logE],
        sum_data_sky_map_smooth[logE],
        sum_bkgd_sky_map_smooth[logE],
        sum_flux_sky_map_smooth[logE],
        sum_flux_err_sky_map_smooth[logE],
        sum_flux_syst_sky_map_smooth[logE],
        avg_energy,
        delta_energy,
        syst_sky_map=sum_syst_sky_map_smooth[logE],
    )
    make_flux_map(
        sum_incl_sky_map_smooth[logE],
        sum_data_sky_map[logE],
        sum_bkgd_sky_map[logE],
        sum_flux_sky_map[logE],
        sum_flux_err_sky_map[logE],
        sum_flux_syst_sky_map[logE],
        avg_energy,
        delta_energy,
        syst_sky_map=sum_syst_sky_map[logE],
    )

for mimic in range(0, n_mimic):
    for logE in range(0, logE_nbins):
        make_flux_map(
            sum_mimic_incl_sky_map_smooth[mimic][logE],
            sum_mimic_data_sky_map[mimic][logE],
            sum_mimic_bkgd_sky_map[mimic][logE],
            sum_mimic_flux_sky_map[mimic][logE],
            sum_mimic_flux_err_sky_map[mimic][logE],
            avg_energy,
            delta_energy,
        )
...
for logE in range(plot_logE_min, plot_logE_max):
    PlotSkyMap(
        fig,
        "$E^{2}$ dN/dE [$\\mathrm{TeV}\\cdot\\mathrm{cm}^{-2}\\mathrm{s}^{-1}$]",
        logE,
        logE + 1,
        sum_flux_sky_map_smooth[logE],
        f"flux_sky_map_{source_name}_logE{logE}_{plot_tag}",
        roi_x=all_roi_x,
        roi_y=all_roi_y,
        roi_r=all_roi_r,
        excl_x=all_excl_x,
    ...
    PlotSkyMap(
        ...
        logE + 1,
        sum_bkgd_sky_map_smooth[logE],
        f"bkgd_sky_map_{source_name}_logE{logE}_{plot_tag}",
        roi_x=all_roi_x,
        roi_y=all_roi_y,
        roi_r=all_roi_r,
        excl_x=all_excl_x,
    ...
    PlotSkyMap(
        ...
        logE + 1,
        sum_excess_sky_map_smooth[logE],
        f"excess_sky_map_{source_name}_logE{logE}_{plot_tag}",
        roi_x=all_roi_x,
        roi_y=all_roi_y,
        roi_r=all_roi_r,
        excl_x=all_excl_x,
    ...
    for mimic in range(0, n_mimic):
        ...
        sum_mimic_flux_err_sky_map_allE[mimic].addSquare(
            sum_mimic_flux_err_sky_map[mimic][logE]
        )
    if logE < plot_logE_min:
        continue
    if logE > plot_logE_max:
        continue
    if logE >= plot_logE_min and logE < plot_logE_mid:
        ...
        for mimic in range(0, n_mimic):
            ...
            sum_mimic_flux_err_sky_map_LE[mimic].addSquare(
                sum_mimic_flux_err_sky_map[mimic][logE]
            )
    if logE >= plot_logE_mid and logE <= plot_logE_max:
        ...
        for mimic in range(0, n_mimic):
            ...
            sum_mimic_flux_err_sky_map_HE[mimic].addSquare(
                sum_mimic_flux_err_sky_map[mimic][logE]
            )
PlotSkyMap(
    fig,
    ...
    plot_logE_min,
    plot_logE_max,
    sum_flux_sky_map_allE_smooth,
    f"flux_sky_map_{source_name}_allE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_min,
    plot_logE_mid,
    sum_flux_sky_map_LE_smooth,
    f"flux_sky_map_{source_name}_LE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_mid,
    plot_logE_max,
    sum_flux_sky_map_HE_smooth,
    f"flux_sky_map_{source_name}_HE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
if onoff == "ON":
    ...
    fit_2d_model(
        sum_data_sky_map_allE, sum_bkgd_sky_map_allE, all_roi_x[0], all_roi_y[0]
    )
    print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")

low_energy = int(1000.0 * pow(10.0, logE_bins[plot_logE_min]))
high_energy = int(1000.0 * pow(10.0, logE_bins[plot_logE_mid]))
SaveFITS(
    sum_flux_sky_map_LE_smooth, f"sum_flux_sky_map_{low_energy}GeV_{high_energy}GeV"
)
SaveFITS(
    sum_flux_err_sky_map_LE_smooth,
    f"sum_flux_err_sky_map_{low_energy}GeV_{high_energy}GeV",
)
low_energy = int(1000.0 * pow(10.0, logE_bins[plot_logE_mid]))
high_energy = int(1000.0 * pow(10.0, logE_bins[plot_logE_max]))
SaveFITS(
    sum_flux_sky_map_HE_smooth, f"sum_flux_sky_map_{low_energy}GeV_{high_energy}GeV"
)
SaveFITS(
    sum_flux_err_sky_map_HE_smooth,
    f"sum_flux_err_sky_map_{low_energy}GeV_{high_energy}GeV",
)
for logE in range(plot_logE_min, plot_logE_max):
    low_energy = int(1000.0 * pow(10.0, logE_bins[logE]))
    high_energy = int(1000.0 * pow(10.0, logE_bins[logE + 1]))
    SaveFITS(
        sum_flux_sky_map_smooth[logE],
        f"sum_flux_sky_map_{low_energy}GeV_{high_energy}GeV",
    )
    SaveFITS(
        sum_flux_err_sky_map_smooth[logE],
        f"sum_flux_err_sky_map_{low_energy}GeV_{high_energy}GeV",
...
for logE in range(plot_logE_min, plot_logE_max):
    on_radial_axis, on_profile_axis, on_profile_err_axis, on_profile_syst_axis = (
        GetRadialProfile(
            sum_flux_sky_map[logE],
            sum_flux_err_sky_map[logE],
            sum_flux_syst_sky_map[logE],
    ...
    axbig.fill_between(
        on_radial_axis,
        np.array(baseline_yaxis) - np.array(on_profile_syst_axis),
        np.array(baseline_yaxis) + np.array(on_profile_syst_axis),
        alpha=0.2,
        color="b",
    )
    ...
    axbig.set_title(
        f"{pow(10.,logE_bins[logE]):0.2f}-{pow(10.,logE_bins[logE+1]):0.2f} TeV"
    )
    fig.savefig(
        f"output_plots/surface_brightness_{source_name}_logE{logE}_{all_roi_name[0]}_{plot_tag}.png",
        bbox_inches="tight",
    )
    axbig.remove()
...
on_radial_axis, on_profile_axis, on_profile_err_axis, on_profile_syst_axis = (
    GetRadialProfile(
        sum_flux_sky_map_allE,
        sum_flux_err_sky_map_allE,
        sum_flux_syst_sky_map_allE,
        all_roi_x,
        all_roi_y,
        2.5,
        all_excl_x,
...
axbig.set_ylabel(label_y, fontsize=fig_fontsize)
axbig.set_title(
    f"{pow(10.,logE_bins[plot_logE_min]):0.2f}-{pow(10.,logE_bins[plot_logE_max]):0.2f} TeV"
)
axbig.fill_between(
    on_radial_axis,
    np.array(baseline_yaxis) - np.array(on_profile_syst_axis),
...
fig.savefig(
    f"output_plots/surface_brightness_{source_name}_allE_{all_roi_name[0]}_{plot_tag}.png",
    bbox_inches="tight",
)
axbig.remove()
txtfile = open(
    f"output_plots/txt_surface_brightness_{source_name}_allE_{all_roi_name[0]}_{plot_tag}.txt",
    "w",
)
...
on_radial_axis, on_profile_axis, on_profile_err_axis, on_profile_syst_axis = (
    GetRadialProfile(
        sum_flux_sky_map_LE,
        sum_flux_err_sky_map_LE,
        sum_flux_syst_sky_map_LE,
        all_roi_x,
        all_roi_y,
        2.5,
        all_excl_x,
...
axbig.set_ylabel(label_y, fontsize=fig_fontsize)
axbig.set_title(
    f"{pow(10.,logE_bins[plot_logE_min]):0.2f}-{pow(10.,logE_bins[plot_logE_mid]):0.2f} TeV"
)
axbig.fill_between(
    on_radial_axis,
    np.array(baseline_yaxis) - np.array(on_profile_syst_axis),
...
fig.savefig(
    f"output_plots/surface_brightness_{source_name}_LE_{all_roi_name[0]}_{plot_tag}.png",
    bbox_inches="tight",
)
axbig.remove()
txtfile = open(
    f"output_plots/txt_surface_brightness_{source_name}_LE_{all_roi_name[0]}_{plot_tag}.txt",
    "w",
)
...
on_radial_axis, on_profile_axis, on_profile_err_axis, on_profile_syst_axis = (
    GetRadialProfile(
        sum_flux_sky_map_HE,
        sum_flux_err_sky_map_HE,
        sum_flux_syst_sky_map_HE,
        all_roi_x,
        all_roi_y,
        2.5,
        all_excl_x,
...
axbig.set_ylabel(label_y, fontsize=fig_fontsize)
axbig.set_title(
    f"{pow(10.,logE_bins[plot_logE_mid]):0.2f}-{pow(10.,logE_bins[plot_logE_max]):0.2f} TeV"
)
axbig.fill_between(
    on_radial_axis,
    np.array(baseline_yaxis) - np.array(on_profile_syst_axis),
...
fig.savefig(
    f"output_plots/surface_brightness_{source_name}_HE_{all_roi_name[0]}_{plot_tag}.png",
    bbox_inches="tight",
)
axbig.remove()
txtfile = open(
    f"output_plots/txt_surface_brightness_{source_name}_HE_{all_roi_name[0]}_{plot_tag}.txt",
    "w",
)
...
if "PSR_J1856_p0245" in source_name:
    ...
    fig.savefig(
        f"output_plots/surface_brightness_{source_name}_Fermi_{plot_tag}.png",
        bbox_inches="tight",
    )
    axbig.remove()
...
for logE in range(plot_logE_min, plot_logE_max):
    ...
    PlotSkyMap(
        ...
        logE + 1,
        sum_significance_sky_map[logE],
        f"significance_sky_map_{source_name}_logE{logE}_{plot_tag}",
        roi_x=all_roi_x,
        roi_y=all_roi_y,
        roi_r=all_roi_r,
        excl_x=all_excl_x,
...
for logE in range(plot_logE_min, plot_logE_max):
    ...
    im = axbig.imshow(
        sum_data_xyvar_map[logE].waxis[:, :, 0].T,
        origin="lower",
    ...
    lable_region = f"CR-1"
    txt = axbig.text(-0.5, 0.4 + 2.0 * MSCW_cut[logE], lable_region, fontdict=font)
    lable_region = f"CR-2"
    txt = axbig.text(-0.5, 0.4 + 4.0 * MSCW_cut[logE], lable_region, fontdict=font)
    lable_region = f"CR-3"
    txt = axbig.text(-0.5, 0.4 + 6.0 * MSCW_cut[logE], lable_region, fontdict=font)
    lable_region = f"CR-4"
    txt = axbig.text(-0.5 + 2.0 * MSCL_cut[logE], 0.4, lable_region, fontdict=font)
    lable_region = f"CR-5"
    txt = axbig.text(
        -0.5 + 2.0 * MSCL_cut[logE],
        0.4 + 2.0 * MSCW_cut[logE],
        lable_region,
        fontdict=font,
    )
    lable_region = f"CR-6"
    ...
    txt = axbig.text(
        -0.5 + 2.0 * MSCL_cut[logE],
        0.4 + 6.0 * MSCW_cut[logE],
        lable_region,
        fontdict=font,
    )
    x_coord = np.array([1.0, 1.0]) * MSCL_cut[logE]
    y_coord = np.array([-1.0, 7.0]) * MSCW_cut[logE]
    axbig.plot(x_coord, y_coord, color="r", linestyle="solid", linewidth=1)
    x_coord = np.array([-1.0, 3.0]) * MSCL_cut[logE]
    y_coord = np.array([1.0, 1.0]) * MSCW_cut[logE]
    axbig.plot(x_coord, y_coord, color="r", linestyle="solid", linewidth=1)
    x_coord = np.array([-1.0, 3.0]) * MSCL_cut[logE]
    y_coord = np.array([3.0, 3.0]) * MSCW_cut[logE]
    axbig.plot(x_coord, y_coord, color="r", linestyle="solid", linewidth=1)
    x_coord = np.array([-1.0, 3.0]) * MSCL_cut[logE]
    y_coord = np.array([5.0, 5.0]) * MSCW_cut[logE]
    axbig.plot(x_coord, y_coord, color="r", linestyle="solid", linewidth=1)
    fig.savefig(
        f"output_plots/xyvar_map_inclusive_data_{source_name}_transpose_{plot_tag}_logE{logE}.png",
        bbox_inches="tight",
    )
    axbig.remove()
...
fig.clf()
figsize_y = 2.0 * gcut_bins
figsize_x = 2.0 * (plot_logE_max - plot_logE_min)
fig.set_figheight(figsize_y)
fig.set_figwidth(figsize_x)
ax_idx = 0
...
for logE in range(plot_logE_min, plot_logE_max):
    for gcut in range(0, gcut_bins):
        ...
        if gcut == 0:
            axbig.set_title(
                f"{pow(10.,logE_bins[logE]):0.2f}-{pow(10.,logE_bins[logE+1]):0.2f}\n TeV",
        ...
        im = axbig.imshow(
            sum_data_xyoff_map[logE].waxis[:, :, gcut].T,
            origin="lower",
            extent=(xmin, xmax, ymin, ymax),
            aspect="auto",
        )
fig.savefig(
    f"output_plots/xyoff_map_inclusive_data_{source_name}_transpose_{plot_tag}.png",
    bbox_inches="tight",
)
axbig.remove()
...
for logE in range(plot_logE_min, plot_logE_max):
    for gcut in range(0, gcut_bins):
        ...
        ymax = sum_data_xyoff_map[logE].yaxis.max()
        im = axbig.imshow(
            sum_err_xyoff_map[logE].waxis[:, :, gcut].T,
            origin="lower",
            extent=(xmin, xmax, ymin, ymax),
            aspect="auto",
            vmin=-5.0,
...
ins_ax = fig.add_axes(
    [0.905, 0.125, 0.010, 0.75]
)  # [lower left x, lower left y, width, height] w.r.t. fig
cb = fig.colorbar(im, cax=ins_ax)
fig.savefig(
    f"output_plots/xyoff_map_inclusive_err_{source_name}_transpose_{plot_tag}.png",
    bbox_inches="tight",
)
axbig.remove()


plot_camera_frame_power_spectrum(
    fig, f"{source_name}_LE_{plot_tag}", sum_significance_sky_map_LE, idx_z=0
)
plot_camera_frame_power_spectrum(
    fig, f"{source_name}_HE_{plot_tag}", sum_significance_sky_map_HE, idx_z=0
)
...
PlotSkyMap(
    ...
    plot_logE_max,
    sum_significance_sky_map_allE,
    f"significance_sky_map_{source_name}_allE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_max,
    sum_excess_sky_map_allE,
    f"excess_sky_map_{source_name}_allE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_mid,
    sum_significance_sky_map_LE,
    f"significance_sky_map_{source_name}_LE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_mid,
    sum_excess_sky_map_LE,
    f"excess_sky_map_{source_name}_LE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_max,
    sum_significance_sky_map_HE,
    f"significance_sky_map_{source_name}_HE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_max,
    sum_excess_sky_map_HE,
    f"excess_sky_map_{source_name}_HE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_min,
    plot_logE_max,
    sum_syst_sky_map_allE,
    f"excess_err_sky_map_{source_name}_allE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_mid,
    sum_syst_sky_map_LE,
    f"excess_err_sky_map_{source_name}_LE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
PlotSkyMap(
    ...
    plot_logE_max,
    sum_syst_sky_map_HE,
    f"excess_err_sky_map_{source_name}_HE_{plot_tag}",
    roi_x=all_roi_x,
    roi_y=all_roi_y,
    roi_r=all_roi_r,
    excl_x=all_excl_x,
...
for mimic in range(0, n_mimic):
    PlotSkyMap(
        ...
        plot_logE_max,
        sum_mimic_significance_sky_map_allE[mimic],
        f"significance_sky_map_{source_name}_allE_mimic{mimic}_{plot_tag}",
        roi_x=all_roi_x,
        roi_y=all_roi_y,
        roi_r=all_roi_r,
        excl_x=all_excl_x,
...
PlotCountProjection(
    ...
    label_x,
    label_y,
    f"projection_sky_map_{source_name}_allE_{plot_tag}",
    hist_map_syst=sum_syst_sky_map_allE,
    roi_x=all_excl_x,
    roi_y=all_excl_y,
    roi_r=all_excl_r,
    colormap="magma",
...
PlotCountProjection(
    ...
    label_x,
    label_y,
    f"projection_sky_map_{source_name}_LE_{plot_tag}",
    hist_map_syst=sum_syst_sky_map_LE,
    roi_x=all_excl_x,
    roi_y=all_excl_y,
    roi_r=all_excl_r,
    colormap="magma",
...
PlotCountProjection(
    ...
    label_x,
    label_y,
    f"projection_sky_map_{source_name}_HE_{plot_tag}",
    hist_map_syst=sum_syst_sky_map_HE,
    roi_x=all_excl_x,
    roi_y=all_excl_y,
    roi_r=all_excl_r,
    colormap="magma",
...
for mimic in range(0, n_mimic):
    PlotCountProjection(
        ...
        label_x,
        label_y,
        f"projection_sky_map_{source_name}_allE_mimic{mimic}_{plot_tag}",
        roi_x=all_excl_x,
        roi_y=all_excl_y,
        roi_r=all_excl_r,
        colormap="magma",
    ...
    PlotCountProjection(
        ...
        plot_logE_min,
        plot_logE_mid,
        sum_mimic_data_sky_map_LE[mimic],
        sum_mimic_bkgd_sky_map_LE[mimic],
        label_x,
        label_y,
        f"projection_sky_map_{source_name}_LE_mimic{mimic}_{plot_tag}",
        roi_x=all_excl_x,
        roi_y=all_excl_y,
        roi_r=all_excl_r,
        colormap="magma",
    ...
    PlotCountProjection(
        ...
        plot_logE_mid,
        plot_logE_max,
        sum_mimic_data_sky_map_HE[mimic],
        sum_mimic_bkgd_sky_map_HE[mimic],
        label_x,
        label_y,
        f"projection_sky_map_{source_name}_HE_mimic{mimic}_{plot_tag}",
        roi_x=all_excl_x,
        roi_y=all_excl_y,
        roi_r=all_excl_r,
        colormap="magma",
...
if "PSR_J1856_p0245" in source_name:
    ...
    GetSlicedDataCubeMapGALFA(MWL_map_file, HI_sky_map, 81.0 * 1e3, 102.0 * 1e3)
    PlotSkyMap(
        fig,
        "Column density [$1/\mathrm{cm}^{2}$]",
        plot_logE_min,
        plot_logE_max,
        HI_sky_map,
        f"Gas_HI_sky_map_{source_name}_p81_p102_{plot_tag}",
        colormap="magma",
        zoomin=zoomin,
    )

    CO_sky_map = MyArray3D(
        x_bins=skymap_bins,
        start_x=xsky_start,
        end_x=xsky_end,
        y_bins=skymap_bins,
    ...
    GetSlicedDataCubeMap(MWL_map_file, CO_sky_map, 81.0, 102.0)
    PlotSkyMap(
        fig,
        "Column density [$1/\mathrm{cm}^{2}$]",
        plot_logE_min,
        plot_logE_max,
        CO_sky_map,
        f"Gas_CO_sky_map_{source_name}_p81_p102_{plot_tag}",
        colormap="magma",
        zoomin=zoomin,
    )
...
for star in range(0, len(other_stars)):
    if abs(src_ra - other_star_coord[star][0]) > skymap_size:
        continue
    if abs(src_dec - other_star_coord[star][1]) > skymap_size:
        continue
    print(
        f"Star {other_stars[star]} RA = {other_star_coord[star][0]:0.2f}, Dec = {other_star_coord[star][1]:0.2f}"
    )
