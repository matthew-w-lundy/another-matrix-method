...
input_params += [["AUX_files", 0.0, 0.0, 30, 90]]
...
for s in range(0, len(input_params)):
    ...
    if input_params[s][0] == "AUX_files":
        file.write(
            'python3 veritas_db_query.py "%s" %s %s %s %s "V4V5V6"\n'
            % (
                input_params[s][0],
                input_params[s][1],
                input_params[s][2],
        ...
        file.write(
            'python3 veritas_db_query.py "%s" %s %s %s %s "V6"\n'
            % (
                input_params[s][0],
                input_params[s][1],
                input_params[s][2],
        ...
        file.write(
            'python3 veritas_db_query.py "%s" %s %s %s %s "V5"\n'
            % (
                input_params[s][0],
                input_params[s][1],
                input_params[s][2],
        ...
        file.write(
            'python3 veritas_db_query.py "%s" %s %s %s %s "V4"\n'
            % (
                input_params[s][0],
                input_params[s][1],
                input_params[s][2],
